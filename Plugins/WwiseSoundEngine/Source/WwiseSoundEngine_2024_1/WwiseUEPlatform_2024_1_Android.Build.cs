...
public class WwiseUEPlatform_2024_1_Android : WwiseUEPlatform
{
	private List<string> AndroidSDKFolders;
	public WwiseUEPlatform_2024_1_Android(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) 
	{
